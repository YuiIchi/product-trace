...
description: 新需求门控。当 Sprint 进行中有新需求到达、不属于当前 Sprint 已有 Story 范围时 MUST 使用此 SKILL。判定增量/新Feature/紧急，插入正确的流程位置并更新 ROADMAP.md。不让新需求无声溜进 Sprint。关键词：新需求、增量、紧急、Feature、Backlog、门控。
---
