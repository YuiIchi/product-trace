...
description: Sprint 验收。当 Sprint 所有 Story [x] 后必须在新会话中 MUST 使用此 SKILL。独立 QA 视角——你不知道代码怎么写的，只对照 spec.md 的验收标准逐条检查代码实际行为。先做漂移审计（文档和代码之间有没有没记录在案的差异），再逐 AC 验收。产出 acceptance/vN.md。关键词：验收、QA、AC、漂移审计、验收报告。
---
